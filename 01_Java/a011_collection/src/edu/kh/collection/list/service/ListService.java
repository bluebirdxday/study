...
public class ListService {
	 ...
	 * 
	 * 인덱스를 이용해서 순서 유지
	 * 순서 구분이 가능하기 때문에 중복되는 데이터 저장 허용
	 * 
	 * List 인터페이스를
	 *
	 * */
...
//		ArrayList list = new ArrayList(); // 기본 생성자 -> 10칸짜리 생성
		...
		list.add(3.14); // Double로 저장  -> AutoBoxing
...
//		list.add(10, "삽입");   -> 오류 발생
		...
		// E get(int index) : 주어진 index 요소 반환
		System.out.println(list.get(3));

		// int size() : 리스트 크기 X, 리스트에 저장된 요소의 개수 0
