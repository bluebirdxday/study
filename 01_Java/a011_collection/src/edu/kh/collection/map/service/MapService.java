...
public class MapService {
	...
	public void ex1() {
		...
		// Map에서 Key만 묶어보면 Set의 특징을 갖음
		// + 향상된 for문
		// -> Map에서 저장된 모든 객체의 Value만 출력하기
		
		Set<Integer> keys = map.keySet();
		// Set<T> keySet() : Key만 모아서 Set 형태로 반환해주는 메서드
...
//		Map<String, Object> member = new HashMap(); 
		Map<String, Object> member = new LinkedHashMap(); // 넣은 순서 유지됨
