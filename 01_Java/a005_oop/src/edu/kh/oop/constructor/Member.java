...
public class Member {
	...
	// 인스턴스 초기화 블럭 : 인스턴스 벼수를 초기화 하는 블럭
	{
		memberId = "mem1";
		memberPw = "1234";
		memberName = "고길동";
	...
	// 매개변수 생성자
	// 객체 생성 시 (생성자 호출 시)
	// () 안에 객체의 필드를 초기화할 값을 전달받는 생성자
	
	public Member(String memberId, String memberPw, 
			String memberName, int memberAge) {
		
		// Member() 생성자 호출 시 
		// () 안에 String, String, String, int를 작성하라
	...
	// 2. (중요!) 매개변수의 자료형 || 개수 || 순서 중 하나라도 달라야 함
	
	public Member(String memberId) {
		
		this(); // 현재 클래스의 기본 생성자 호출
		// --> this() 생성자
		// --> 중복 제거, 코드 길이 감소를 위해 사용
		this.memberId = memberId;
