...
public class Student {
	...
	// 필드를 가지고 있는 자식 클래스가 알맞은 형태로 재정의 필요
	@Override
	public boolean equals(Object obj) {
		...
		if(!this.name.equals(obj)) return false;
	...
	// Object.hashCode();
	// 두 객체의 필드 값이 같다면 해시코드도 똑같은 정수 값을 반환해야 함
	
	// hash 함수 : 입력받은 문자열/숫자를 특정한 길이의 물자열/숫자로 변환
	//             -> 최대한 중복되지 않는 숫자를 만들어냄
	
	
	// hashCode() : 객체의 필드 값을 이용해서 일정한 길이의 숫자를 만드는 함수
	// 왜 필요한가? Java 실행 시 내부에서 객체를 검색하는 속도를 증가
