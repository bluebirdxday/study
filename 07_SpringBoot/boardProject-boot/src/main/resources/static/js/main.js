...
btn2.addEventListener("click", ()=>{
    ...
    // POST 방식 비동기 요청 - fetch("요청주소", 자바스크립트 객체)
...
function getCookie(key){
    ...
    // saveId=user01@kh.or.kr; test=가다나; aaa=100
    // 배열.map() : 배열의 모든 요소를 순차접근하여 함수 수행 후 수행 결과를 이용해서 새로운 배열을 만드는 함수
