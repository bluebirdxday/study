 ...
 * 		매핑할 주소를 연결하라고 지시하는 어노테이션 (web.xml에 일일이 등록할 필요가 없어짐)
...
// Servlet 관련 코드를 작성하기 위해서는 HttpSevlet 클래스를 상속받아야함
// -> Tomcat에서 제공
public class ExampleController2 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// out.print(type.equals("ICE")? "차가운" : "따뜻한");
		...
		//		전달된 값 중 name이 일치하는 값이 없으면 null 반환
		if(optionArr!=null) {
			out.println("<ul>");
