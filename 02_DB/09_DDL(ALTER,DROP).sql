...
ALTER TABLE DEPT_COPY DROP CONSTRAINT SYS_C007537; -- NOT NULL
--> NOT NULL 제약조건 ADD는 안되는데 DROP은 가능


-- NOT NULL 제거 시 MODIFY 사용
ALTER TABLE DEPT_DOPY 
MODIFY DEPT_TITLE CONSTRAINT SYS_C007537 /*NOT*/ NULL;
...
-- DDL : 데이터 정의어 (객체를 CREATE, ALTER, DROP)
-- DML : 데이터 조작어 (테이블의 값을 INSERT, UPDATE, DELETE)
...
-- ROLLBACK해도 되돌리지 못하게 됨 (트랜잭션에 쌓인 DML을 강제로 밀고 들어가서 COMMIT 시키니까)
