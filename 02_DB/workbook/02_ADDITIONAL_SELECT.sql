...
ABS(TRUNC(MONTHS_BETWEEN(SYSDATE, TO_DATE(SUBSTR(PROFESSOR_SSN, 1, 6), 'YYMMDD'))/12)) 나이
FROM TB_PROFESSOR
...
FROM TB_STUDENT
WHERE 
MONTHS_BETWEEN(TO_DATE(SUBSTR(STUDENT_SSN, 1, 6),'YYMMDD'), ENTRANCE_DATE)/12 > 19;
...
SELECT STUDENT_NAME, NVL(ABSENCE_YN, '0')
FROM TB_STUDENT;
