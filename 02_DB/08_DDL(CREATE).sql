...
/* 자료형
    ...
    DATE : 날짜 타입
    BLOB : 대용량 이진 데이터 (4GB) ex) 이미지 같은 것
    CLOB : 대용량 문자 데이터 (4GB)
*/
...
CREATE TABLE MEMBER(
	...
	MEMBER_SSN CHAR(14),      		  -- 990123-4567890 (항상 14글자)
...
-- 스크롤 하고 ALT+X 누르면 선택한 스크립트를 모두 실행
...
INSERT INTO MEMBER VALUES('MEM01', '123ABC', '홍길동', '990123-1234567', SYSDATE);
...
INSERT INTO MEMBER
VALUES('ABC1234', 'ATTWER25', '박철수', '950505-1948237', DEFAULT);
...
VALUES('MEM04', '1234567', '이지연', '000101-5678901');
...
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(BLU.SYS_C007460)에 위배됩니다
...
AND UCC.CONSTRAINT_NAME = 'USER_USED_UK';
...
-- NOT NULL + UNIQUE 제약조건의 의미 -> (의미만 비슷), 중복도 안 되고 NULL도 안 되고
...
--> 기본키가 NULL 이므로 오류
-- ORA-01400: NULL을 ("BLU"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
...
-- ORA-00001: 무결성 제약 조건(BLU.PK_USERNO_USERID)에 위배됩니다
...
-- ORA-01400: NULL을 ("BLU"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
...
CREATE TABLE USER_USED_FK(
  ...
  -- 컬럼 레벨로 FK 제약조건 설정 (UNIQUE 키 OR PRIMARY KEY만 지정 가능)
...
--> NULL(외부 테이블에 참조할 값이 없다, 참조를 안 할 거다는 의미) 사용 가능.
...
-- ORA-02291: 무결성 제약조건(BLU.GRADE_CODE_FK1)이 위배되었습니다- 부모 키가 없습니다
-- 참조할 값을 제공해주는 쪽 : 부모
...
DELETE FROM USER_GRADE 
WHERE GRADE_CODE = 10;
-- ORA-02292: 무결성 제약조건(BLU.GRADE_CODE_FK1)이 위배되었습니다
--            자식 레코드가 발견되었습니다
...
-- ORA-02290: 체크 제약조건(BLU.GENDER_CHECK)이 위배되었습니다
...
VALUES(1, 'hongil', 'dong1', '990101-2345678', '남', '01012345677', '서울특별시 강남구', 'Y');

INSERT INTO USER_TEST2
VALUES(2, 'young', 'hee2', '990808-6309183', '여', '01069238921', '서울특별시 성북구', 'N');

INSERT INTO USER_TEST2
VALUES(3, 'abc123', 'djf53', '940202-6982931', '여', '0106980921', '서울특별시 땡땡구', 'Y');

INSERT INTO USER_TEST2
VALUES(4, 'kyonh09', 'yoo921', '011124-1298975', '남', '01023915930', '서울특별시 강북구', 'N');

INSERT INTO USER_TEST2
VALUES(5, 'cha1284', 'ewnoo00', '970913-5490322', '남', '01068477281', '서울특별시 어쩌구', 'Y');
...
-- 컬럼명, 데이터 타입, 값이 복사되고, 제약조건은 NOT NULL 만 복사됨(PK 같은 건 복사 안됨)
...
FOREIGN KEY(LOCATION_ID) REFERENCES LOCATION;  --> 테이블명만 작성하면 자동으로 PK 연결 
