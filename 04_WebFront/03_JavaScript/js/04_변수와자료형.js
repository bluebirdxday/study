...
// ReferenceError: num3 is not defined (정의되지 않음 == 존재하지 않거나 접근 불가능)
...
function testFn2(){
    ...
    // ReferenceError: let3 is not defined
    // console.log("if문 내부 let3 : " + let3);
}

testFn2();

// ReferenceError: let2 is not defined 
// console.log("함수 내부에 선언한 let2 : " + let2);  // 에러


// var의 호이스팅
// 변수가 선언되기 전에 사용 가능하게 하는 기술
// -> error가 발생하지 않고 undefined 출력됨
console.log(test);
var test = 10;
console.log(test);
...
function typeTest(){
    ...
    box.innerHTML += "<br>user.pw : " + user.id + "/" + typeof user.id;
