...
/* 
    location.pathname  =>  '/board/2/1503' 

    location.pathname.replace("board", "board2") + "/update"
    => '/board2/2/1503/update'
    
    location.search  => '?cp=1'

    location.href = location.pathname.replace("board", "board2") + "/update" + location.search
    =>  '/board2/1/2006/update?cp=1'
...
document.getElementById("updateBtn").addEventListener("click", ()=>{
    ...
    //      /board2/1/2006/update?cp=1  (GET방식 요청)
});
