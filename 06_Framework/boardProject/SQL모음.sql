...
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'user02@kh.or.kr', 'pass02!'
	, '이번유저', '01077778888', '04540,,서울시 중구 남대문로 120,,2층', 
	NULL, DEFAULT, DEFAULT, DEFAULT);
...
SELECT MEMBER_NO, MEMBER_EMAIL, MEMBER_NICKNAME,
		MEMBER_TEL, NVL(MEMBER_ADDR, '미작성') MEMBER_ADDR,
		TO_CHAR(ENROLL_DATE, 'YYYY"년" MM"월" DD"일" HH24"시" MI"분" SS"초"') AS ENROLL_DATE
FROM "MEMBER"
WHERE MEMBER_EMAIL = 'user01@kh.or.kr'
AND MEMBER_DEL_FL = 'N';
...
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00001.jpg', 'cat1.jpg', 0, 1498);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00002.jpg', 'cat2.jpg', 0, 1495);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00003.jpg', 'cat3.jpg', 0, 1487);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00004.jpg', 'cat4.jpg', 0, 1485);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00005.jpg', 'cat5.jpg', 0, 1483);
...
-- 특정 게시글에 존재하는 이미지 조회(IMG_OREDER 오름차순)
SELECT * FROM BOARD_IMG
WHERE BOARD_NO = 1498
ORDER BY IMG_ORDER;
...
INSERT INTO BOARD_IMG 
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
'20230508115013_00002.jpg', 'cat2.jpg', 1, 1498);

INSERT INTO BOARD_IMG 
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
'20230508115013_00003.jpg', 'cat3.jpg', 2, 1498);
...
UPDATE "BOARD" SET BOARD_DEL_FL='N' WHERE BOARD_NO = 1505;


SELECT * FROM "BOARD"
ORDER BY BOARD_NO DESC;

INSERT INTO "COMMENT"								--게시글 회원 번호
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 1', DEFAULT, DEFAULT, 1502, 2, NULL);

INSERT INTO "COMMENT"		
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 2', DEFAULT, DEFAULT, 1502, 8, NULL);

INSERT INTO "COMMENT"		
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-1', DEFAULT, DEFAULT, 1502, 8, 1001);

INSERT INTO "COMMENT"		
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-2', DEFAULT, DEFAULT, 1502, 1, 1001);

INSERT INTO "COMMENT"		
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-3', DEFAULT, DEFAULT, 1502, 2, 1001);

INSERT INTO "COMMENT"		
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-1', DEFAULT, DEFAULT, 1502, 2, 1002);

INSERT INTO "COMMENT"		
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-2', DEFAULT, DEFAULT, 1502, 1, 1002);

INSERT INTO "COMMENT"		
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식의 자식 댓글 2-1-1', DEFAULT, DEFAULT, 1502, 8, 1006);
...
-- 회원 프로필 이미지 변경
UPDATE "MEMBER" SET 
PROFILE_IMG = '/resources/images/member/Group 42.png'
WHERE MEMBER_NO = 1;
...
WHERE BOARD_NO = 1489	-- 게시글 번호
AND MEMBER_NO = 1;-- 로그인 회원 번호



-- 좋아요 테이블 삽입
INSERT INTO "BOARD_LIKE" VALUES(1489, 1);
...
SELECT SUM(READ_COUNT) FROM "BOARD";
SELECT * FROM "BOARD";
